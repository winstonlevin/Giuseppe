...
from hl20_aero_atm import mu, re, g0, mass, s_ref, CL0_fun, CLa_fun, CD0_fun, CD1_fun, CD2_fun, max_ld_fun,\
    sped_fun, dens_fun
...
CD1 = np.asarray(CD1_fun(mach)).flatten()
...
alpha = (CL - CL0) / CLa
alpha_max_ld = max_ld_fun(_CL0=CL0, _CLa=CLa, _CD0=CD0, _CD1=CD1, _CD2=CD2)['alpha']
