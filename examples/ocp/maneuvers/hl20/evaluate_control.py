...
def alpha_energy_climb(_t: float, _x: np.array, _p_dict: dict, _k_dict: dict) -> float:
    ...
    _drag_glide = _qdyn_s_ref_glide * _CD0_glide \
        + _CD1_glide * _lift_glide \
        + _CD2_glide/_qdyn_s_ref_glide * _lift_glide**2
...
def alpha_lam_h0(_t: float, _x: np.array, _p_dict: dict, _k_dict: dict) -> float:
    ...
    _beta = _lift0**2 + _qdyn_s_ref/_CD2 * (-_r_glide/_r * _drag_glide * _cgam + _CD1 * _lift0 + _qdyn_s_ref * _CD0)
